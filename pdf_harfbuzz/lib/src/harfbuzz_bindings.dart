...
class HarfBuzzBindings {
  HarfBuzzBindings() {
    ...
    hb_blob_destroy = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>),
          void Function(ffi.Pointer<ffi.Opaque>)
        >('hb_blob_destroy');

    hb_face_create = dylib
        .lookupFunction<
          ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, ffi.Uint32),
          ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>, int)
        >('hb_face_create');

    hb_face_destroy = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>),
          void Function(ffi.Pointer<ffi.Opaque>)
        >('hb_face_destroy');

    hb_face_get_upem = dylib
        .lookupFunction<
          ffi.Uint32 Function(ffi.Pointer<ffi.Opaque>),
          int Function(ffi.Pointer<ffi.Opaque>)
        >('hb_face_get_upem');

    hb_font_create = dylib
        .lookupFunction<
          ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>),
          ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Opaque>)
        >('hb_font_create');

    hb_font_destroy = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>),
          void Function(ffi.Pointer<ffi.Opaque>)
        >('hb_font_destroy');

    hb_font_set_scale = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>, ffi.Int32, ffi.Int32),
          void Function(ffi.Pointer<ffi.Opaque>, int, int)
        >('hb_font_set_scale');

    hb_buffer_create = dylib
        .lookupFunction<
          ffi.Pointer<ffi.Opaque> Function(),
          ffi.Pointer<ffi.Opaque> Function()
        >('hb_buffer_create');

    hb_buffer_destroy = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>),
          void Function(ffi.Pointer<ffi.Opaque>)
        >('hb_buffer_destroy');

    hb_buffer_add_utf8 = dylib
        .lookupFunction<
          ffi.Void Function(
    ...
    hb_buffer_guess_segment_properties = dylib
        .lookupFunction<
          ffi.Void Function(ffi.Pointer<ffi.Opaque>),
          void Function(ffi.Pointer<ffi.Opaque>)
    ...
    hb_buffer_get_length = dylib
        .lookupFunction<
          ffi.Uint32 Function(ffi.Pointer<ffi.Opaque>),
          int Function(ffi.Pointer<ffi.Opaque>)
        >('hb_buffer_get_length');

    hb_buffer_get_glyph_infos = dylib
        .lookupFunction<
    ...
    hb_buffer_get_glyph_positions = dylib
        .lookupFunction<
  ...
  ffi.DynamicLibrary _loadHarfBuzz() {
    if (Platform.isMacOS) {
      ...
      for (final path in ['libharfbuzz-0.dll', 'harfbuzz.dll']) {
        try {
          return ffi.DynamicLibrary.open(path);
        } catch (_) {}
      }
